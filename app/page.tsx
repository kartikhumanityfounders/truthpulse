...
export default function FirstImpressionApp() {
  ...
  const VIRAL_HOOKS = [
    "Discover what they're thinking about you...",
    "Uncover the truth behind your profile views...",
    "What your ex really thinks of your updates...",
    "The honest opinion your best friend won't share...",
    "Snap judgments in 3 seconds. Find out more...", 
  ];
  ...
  const convertAIToOriginalFormat = (aiResult: any, hasPhoto: boolean) => {
    ...
    const harsh1 = harshLines[0] || "Are you trying to impress someone? Relax a bit.";
    const harsh2 = harshLines[1] || "There's a sense that you're a bit detached from reality.";
    const harsh3 = harshLines[2] || (hasPhoto ? "Your photos fit a stereotype perfectly." : "It feels all too familiar and uninspired.");
    const harsh4 = harshLines[3] || "Nothing memorable about your words. Just more noise.";
    return {
      harsh1,
      harsh2,
      harsh3,
